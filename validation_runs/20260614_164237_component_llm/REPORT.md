...
- FAIL expected_columns
  ...
  - actual: `['TECH', 'DEN', 'MODE', 'PKG_TYPE1', 'PKG_TYPE2', 'LEAD', 'MCP_NO', 'PRODUCTION_QUANTITY', 'WIP_QUANTITY']`
- PASS non_empty_result
  - expected: `row_count > 0`
  - actual: `2`
- PASS expected_filter_fields
...
- PASS expected_columns
  ...
  - actual: `['TECH', 'DEN', 'MODE', 'PKG_TYPE1', 'PKG_TYPE2', 'LEAD', 'MCP_NO', 'WIP', 'PRODUCTION', 'OUT_PLAN', 'ACHIEVEMENT_RATE', 'OPER_NAME']`
- PASS non_empty_result
  - expected: `row_count > 0`
  - actual: `96`
- PASS expected_filter_fields
...
- FAIL expected_columns
  ...
  - actual: `['EQP_MODEL', 'TOTAL_PRESS_CNT']`
- PASS non_empty_result
  - expected: `row_count > 0`
  - actual: `5`
- PASS expected_filter_fields
