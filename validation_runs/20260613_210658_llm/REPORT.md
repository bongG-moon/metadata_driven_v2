...
- answer: `6건을 찾았습니다. 사용 dataset: wip_today, production_today. 결과 예시: (RANK_GROUP=DA, TECH=TSV, DEN=2048G, MODE=HBM3E, PKG_TYPE1=HBM); (RANK_GROUP=DA, TECH=TSV, DEN=1536G, MODE=HBM3, PKG_TYPE1=HBM); (RANK_GROUP=DA, TECH=TSV, DEN=1024G, MODE=HBM3, PKG_TYPE1=HBM) 외 3건`
...
- PASS expected_columns
  ...
  - actual: `['RANK_GROUP', 'TECH', 'DEN', 'MODE', 'PKG_TYPE1', 'PKG_TYPE2', 'LEAD', 'MCP_NO', 'WIP', 'WIP_RANK', 'PRODUCTION']`
