...
- PASS expected_columns
  ...
  - actual: `['WORK_DT', 'LOT_ID', 'OPER_SHORT_DESC', 'LOT_STAT_CD', 'LOT_HOLD_STAT_CD', 'TECH', 'DEN', 'MODE', 'PKG_TYPE1', 'PKG_TYPE2', 'LEAD', 'MCP_NO', 'TSV_DIE_TYP', 'SUB_PROD_QTY', 'WF_QTY', 'IN_TAT', 'CUM_TAT']`
- PASS non_empty_result
  - expected: `row_count > 0`
  - actual: `161`
- PASS expected_filter_fields
...
## FAIL waiting_lot_count_by_process
