...
- answer: `6건을 찾았습니다. 사용 dataset: wip_today, production_today. 결과 예시: (RANK_GROUP=DA, WIP_RANK=3, TECH=TSV, DEN=1024G, MODE=HBM3); (RANK_GROUP=DA, WIP_RANK=2, TECH=TSV, DEN=1536G, MODE=HBM3); (RANK_GROUP=DA, WIP_RANK=1, TECH=TSV, DEN=2048G, MODE=HBM3E) 외 3건`
