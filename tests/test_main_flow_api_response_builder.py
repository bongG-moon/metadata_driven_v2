...
def test_main_flow_api_response_builder_projects_current_payload() -> None:
    ...
    payload = {
        ...
        "data": {
            ...
            "row_count": 10,
            "data_ref": {"store": "mongodb", "collection_name": "agent_v2_result_store", "ref_id": "result-1"},
        ...
        "state": {"current_data": {"data_ref": {"ref_id": "result-1", "collection_name": "agent_v2_result_store"}}},
