...
def test_mongodb_loader_restores_followup_source_results_when_full_requested(monkeypatch: Any) -> None:
    ...
    for loader_path in [
        "langflow_components/main_flow/01_mongodb_data_loader.py",
...
def test_mongodb_loader_uses_collection_name_from_data_ref(monkeypatch: Any) -> None:
    ...
    default_collection = client["metadata_driven_agent_v2"]["agent_v2_result_store"]
    custom_collection = client["metadata_driven_agent_v2"]["custom_result_store"]
            ...
            "followup_source_results": [
                {
                    ...
                    "data_ref": {
                        "store": "mongodb",
                        "ref_id": "source-ref",
                        "database": "metadata_driven_agent_v2",
...
def test_answer_response_state_preserves_followup_source_refs() -> None:
    source_ref = {"store": "mongodb", "ref_id": "source-ref", "collection_name": "agent_v2_result_store"}
    for builder_path in [
        "langflow_components/main_flow/20_answer_response_builder.py",
        "langflow_components/data_analysis_flow/18_answer_response_builder.py",
    ]:
