...
class MainFlowApiResponseBuilder(Component):
    display_name = "12 Main Flow API Response Builder"
    ...
    inputs = [
        DataInput(name="payload", display_name="Payload", info="Payload output from 10 Answer Response Builder.", input_types=["Data", "JSON"], required=True),
    ]
