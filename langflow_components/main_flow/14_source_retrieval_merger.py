...
class SourceRetrievalMerger(Component):
    display_name = "14 Source Retrieval Merger"
    description = "Merges Oracle, H-API, Datalake, and Goodocs retrieval payloads."
    inputs = [
    ...
    def build_payload(self) -> Data:
        return Data(data=merge_source_retrieval_payloads(self.oracle_retrieval, self.h_api_retrieval, self.datalake_retrieval, self.goodocs_retrieval))
