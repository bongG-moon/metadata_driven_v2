...
def build_table_catalog_authoring_request(
    ...
    collection = _clean(collection_name or f"{prefix}_table_catalog_items")
...
class TableCatalogAuthoringRequestLoader(Component):
    ...
    description = "Starts a table catalog authoring request and optionally loads existing dataset items from MongoDB."
    inputs = [
