...
DEFAULT_DATABASE = "metadata_driven_agent_v2"
DEFAULT_SESSION_COLLECTION = "agent_v2_session_states"
...
def load_session_state_payload(
    ...
    session = _clean(session_id) or _session_id_from_state(explicit_state) or "demo-session"
...
class MongoDBSessionStateLoader(Component):
    ...
    inputs = [
        ...
        DataInput(name="state", display_name="Explicit State", required=False),
